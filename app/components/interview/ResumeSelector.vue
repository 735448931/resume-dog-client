    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex gap-2 items-center">
                ...
                <UButton v-if="userStore.reumes.length < 5" color="primary" variant="ghost" icon="i-heroicons-plus"
        ...
        <div v-else
            ...
            <UButton v-if="userStore.userInfo?.resumes?.length < 5" color="primary" variant="ghost" size="sm"
                class="mt-2" @click="showUploadResumeModal = true">
                立即上传
            </UButton>
        </div>
    </div>
